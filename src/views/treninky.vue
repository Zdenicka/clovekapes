<template>
    ...
    <h3>Tréninky</h3>
        <p>Trénovat u&nbsp;mě můžete přibližně v oblasti mezi Jičínem, Nymburkem a Mladou Boleslaví. V&nbsp;Nymburce a Mladé Boleslavi více či méně pravidelně pořádám i skupinové tréninky.</p>
    <h5>Zaměření</h5>
        ...
        <p>Druhou oblastí na&nbsp;kterou se zaměřuji je řešení již existujícího <b>problémového chování</b>. Ráda budu vám i vašemu psovi pomáhat při práci se&nbsp;strachem, agresí ke psům i lidem i dalšími problémy a pomůžu vám nastavit vaše soužití tak, aby fungovalo pro vás i pro psa.</p>
    <h5>Skupinové tréninky a socializační procházky</h5>
        <p>Skupinové tréninky v současné době nabízím v&nbsp;<a href="https://zkonymburk.blogspot.com/" target="_blank">ZKO Nymburk</a> a Mladé Boleslavi.</p>
