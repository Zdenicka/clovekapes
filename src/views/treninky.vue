<template>
    ...
    <h3>Kurzy</h3>
        <p>Novinkou jsou tři vypsané kurzy, které nabízím v&nbsp;<a href="https://zkonymburk.blogspot.com/" target="_blank">ZKO Nymburk</a>. Tyto kurzy se rozeběhnou hned na počátku září a obsahují i teoretický úvod. Ten není pro účastníky povinný, zato je velmi užitečný.</p>
        <p>Všechny tři kurzy jsou určeny pro puberťáky a dospělé psy a jejich cílem je usnadnit vám společný život nebo nastartovat vaši společnou sportovní kariéru</p>
    <h5>Základy rodinného psa pro dospělé psy</h5>
    ...
    <h5>Všeobecná sportovní přípravka</h5>
        <p>Tady předpokládám, že si se svým psíkem docela rozumíte a máte nějaké sportovní ambice. Ambicí může být i (jen) pravidelné ježdění na tréninky nějakého sportu a vybití nastřádané energie. Nebo možná už i tréninky nějakého sportu navštěvujete a zjistili jste, že by bylo fajn, aby váš psí parťák uměl věci, které nejsou úplně předmětem onoho sportu, ale vám to trén inky ztěžuje a váš trenér nemá čas, aby vám s tím během úzce zaměřených tréninků poradil.
        O co například může jít? Takové klidné čekání, než na vás přijde řada, bývá častým kamenem úrazu. Procvičíme si i naši vlastní schopnost psa učit a motivovat. Zapracujeme na jeho sebekontrole a podíváme se na základní chování, které se vám bude hodit snad vždycky :) </p>
